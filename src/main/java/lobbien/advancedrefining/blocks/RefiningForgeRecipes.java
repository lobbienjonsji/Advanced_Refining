...
public class RefiningForgeRecipes {
	private static final RefiningForgeRecipes INSTANCE = new RefiningForgeRecipes();
	private final Table<ItemStack, ItemStack, ItemStack> smeltingList = HashBasedTable.<ItemStack, ItemStack, ItemStack>create();
	private final Map<ItemStack, Float> experienceList = Maps.<ItemStack, Float>newHashMap();
	
	public static RefiningForgeRecipes getInstance()
	{
		return INSTANCE;
	}
	
	private RefiningForgeRecipes() 
	{
		addRefiningRecipe(new ItemStack(ModItems.UNREFINED_IRON), new ItemStack(Items.COAL), new ItemStack(Blocks.ACACIA_FENCE), 5.0F);
	}
